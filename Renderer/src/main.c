...
float       rot_x_offset 			= 0.05f;
float       rot_y_offset 			= 0.005f;
float       rot_z_offset 			= 0.0f;
...
void update(void){
    ...
    mesh.rotation.x += rot_x_offset;
    mesh.rotation.y += rot_y_offset;
    mesh.rotation.z += rot_z_offset;

...
/********************************************************************************************
 * Draw filled a  triangle with a flat botton
 * 
 *                      (x0, y0)
 *                         /\ 
 *                        /  \
...
/*************************************************************************************
 * Draw a filled triangle with the flat-top/flat-botton methods
 * We split the original triangle in two, half flat-botton and hald flat-top  
 * 
 *                     (x0, y0)
 *                       /  \
 *                      /    \
